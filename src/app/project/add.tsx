    ...
    <Container padded>
      ...
      >
        <Header
          ...
          subtitle="Create a new software project in your App Wallet"
          action={
            <Button
              title="Cancel"
              onPress={() => router.back()}
        ...
        <Card style={styles.formCard}>
          ...
          <TextInput
            label="Description"
            placeholder="Brief overview of the project vision and goals..."
            value={description}
          ...
          <TextInput
            ...
            placeholder="React, Expo, TypeScript, Supabase"
            value={tagsInput}
          ...
          {/* Submit Action */}
          <Button
            title={loading ? 'Creating Project...' : 'Save Project'}
